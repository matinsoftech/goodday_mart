    ...
    public function after(): array
    {
        return [
            function (Validator $validator) {
                ...
                // If recaptcha status is not enabled, do NOT check or require any captcha
                // The following lines should be REMOVED if you want NO CAPTCHA when status is 0.
