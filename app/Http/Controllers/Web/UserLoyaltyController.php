...
class UserLoyaltyController extends Controller
{
    ...
    public function index(Request $request): View|RedirectResponse
    {
        ...
        if ($loyaltyPointStatus == 1) {
            ...
            return view(VIEW_FILE_NAMES['user_loyalty'], compact('totalLoyaltyPoint', 'loyaltyPointStatus', 'walletStatus', 'loyaltyPointList', 'loyaltyPointMinimumPoint', 'loyaltyPointExchangeRate', 'categories'));
        }else{
