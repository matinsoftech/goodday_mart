    ...
    public function user_password_update(Request $request)
{
    ...
    public function address_edit(Request $request, $id)
    {
        ...
        if (isset($shippingAddress)) {
            return view(VIEW_FILE_NAMES['account_address_edit'], compact('shippingAddress', 'country_restrict_status','categories', 'zip_restrict_status', 'delivery_countries', 'delivery_zipcodes', 'countriesName', 'countriesCode'));
        } else {
            Toastr::warning(translate('access_denied'));
            return back();
        }
    ...
    public function single_ticket(Request $request)
    {
        ...
        return view(VIEW_FILE_NAMES['ticket_view'], compact('ticket', 'categories'));
    }
    ...
    public function track_last_order()
    {
        ...
        if ($orderDetails != null) {
            return view('web-views.order.tracking', compact('orderDetails', 'categories'));
        } else {
    ...
    public function submit_review(Request $request, $id)
    {
        ...
        return view('web-views.users-profile.submit-review', compact('order_details', 'categories'));
    ...
    public function refer_earn(Request $request)
    {
        ...
        return view(VIEW_FILE_NAMES['refer_earn'], compact('customer_detail', 'categories'));
    }
