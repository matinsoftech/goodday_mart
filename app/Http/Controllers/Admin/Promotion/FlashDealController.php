...
class FlashDealController extends BaseController
{
    ...
    public function getAddProductView($deal_id): View|JsonResponse
    {
        ...
        //     relations: ['brand', 'category', 'seller.shop'],
        //     dataLimit: (int) getWebConfig('pagination_limit')
        // );

        $dealProducts = $deal->products()->with('product')->paginate(10);
