                                ...
                                <div class="row">
                                    <div class="col-md-12 mt-3">
                                        ...
                                        <div class="dropdown select-product-search w-100">
                                            ...
                                            <button
                                                class="form-control text-start dropdown-toggle text-capitalize select-product-button"
                                            ...
                                            <div class="dropdown-menu w-100 px-2">
                                                ...
                                                <div
                                                    ...
                                                    @include('admin-views.partials._search-product', [
                                                        'products' => $products,
                                                    ])
                                                </div>
                                            </div>
                ...
                <div class="card">
                    <div class="px-3 py-4">
                        <h5 class="mb-0 text-capitalize">
                            ...
                            <span
                                class="badge badge-soft-dark radius-50 fz-12 ml-1">{{ $deal->products->count() ?? '0' }}</span>
                        </h5>
                    </div>
                            ...
                            <tbody>
                                @foreach ($dealProducts as $key => $dealProduct)
                                    <tr>
                                        ...
                                        <td>{{ usdToDefaultCurrency(amount: $dealProduct->product->unit_price ?? 0) }}</td>
                                        <td>
                                            <div class="d-flex justify-content-center">
                                                <a title="{{ translate('delete') }}"
                                                    class="btn btn-outline-danger btn-sm delete-data-without-form"
                                                    data-action="{{ route('admin.deal.delete-product') }}"
