...
@section('content')
    <div class="__inline-23">
                ...
                <div class="col-lg-12 col-12">
                    <div class="row">
                        <div class="col-lg-5 col-md-5 col-12">
                            <div class="cz-product-gallery px-2">
                        ...
                        <div class="col-lg-7 col-md-7 col-12 mt-md-0 mt-sm-3 web-direction">
                            <div class="details __h-100 px-2">
                                <h6 class="text-muted fw-bold mb-1 fs-14">Gooday Mart</h6>
                                <h3 class="mb-2 details-page-theme-col fw-bold">{{ $product->name }}</h3>
                                <div class="d-flex flex-wrap align-items-center mb-2 pro">
                                    ...
                                    <span
                                        class="d-inline-block  align-middle mt-1 ml-2 {{ Session::get('direction') === 'rtl' ? 'ml-md-2 ml-sm-0' : 'mr-md-2 mr-sm-0' }} fs-14 text-muted">{{ $overallRating[0] }}<span
                                            class="details-page-theme-col" style=" bold ;"> Rating</span></span>
                                    <span
                                ...
                                <form id="add-to-cart-form" class="mb-2">
                                    ...
                                    @foreach (json_decode($product->choice_options) as $key => $choice)
                                        <div class="row flex-start mx-0 align-items-center">
                                            <div
                                                class="product-description-label text-dark font-bold {{ Session::get('direction') === 'rtl' ? '' : '' }} text-capitalize ">
                                                {{ $choice->title }}
                                                :
                                            </div>
                                            <div>
                                    ...
                                    <div class="mt-3 d-none">
                                        <div class="product-quantity d-flex flex-column __gap-15">
                                            <div class="d-flex align-items-center gap-3">
                                                <div
                                                    class="product-description-label text-dark font-bold mt-0 details-page-theme-col">
                                                    {{ translate('quantity') }} :
                                                </div>
                                                <div
                                    ...
                                    <div class="__btn-grp my-4 d-none d-sm-flex">
                                        @if (
                                        ...
                                        {{-- <button type="button" data-product-id="{{ $product['id'] }}"
                                            ...
                                            <i class="fa {{ $wishlistStatus == 1 ? 'fa-heart' : 'fa-heart-o' }} wishlist_icon_{{ $product['id'] }} web-text-primary"
                                                aria-hidden="true"></i>
                                            <span
                                                class="fs-14 align-bottom countWishlist-{{ $product['id'] }}">{{ $countWishlist }}</span>
                                        </button> --}}
                                        @if (
                                            ($product->added_by == 'seller' &&
                                                ($sellerTemporaryClose ||
                                    ...
                                    <div class="d-flex">
                                        <button type="button" data-product-id="{{ $product['id'] }}"
                                            class="btn __text-18px border d-block product-action-add-wishlist mr-2"
                                            style="padding:0px">
                                            <i class="fa {{ $wishlistStatus == 1 ? 'fa-heart' : 'fa-heart-o' }} wishlist_icon_{{ $product['id'] }} web-text-primary"
                                                aria-hidden="true"></i>
                                            {{-- <span
                                                class="fs-14 align-bottom countWishlist-{{ $product['id'] }}">{{ $countWishlist }}</span> --}}
                                            <span
                                                class="add-wishlist align-content-center">{{ $wishlistStatus == 1 ? 'REMOVE FROM WISHLIST' : 'ADD TO WISHLIST' }}</span>
                                        </button>
                                    </div>
                                ...
                                <div class="my-4">
                                    <h6 class="fw-bold fs-14 details-page-theme-col">
                                        SKU: {{ $product->code }}
                                    </h6>
                                    <h6 class="fw-bold fs-14 text-black">
                                    ...
                                    @endif
                                    @if ($product['details'])
                                        <h6 class="fw-bold fs-14 text-black product-details">
                                            {!! $product['details'] !!}
                                        </h6>
                                    @endif
                                </div>
                                        ...
                                        <div>
                                            <div
                                                ...
                                                <ul class="nav nav-tabs nav--tabs d-flex justify-content-center mt-3"
                                                    ...
                                                    @endif
                                                    <li class="nav-item">
                                                        <a class="nav-link __inline-27 active" href="#reviews"
                                                            data-toggle="tab" role="tab">
                                                            {{ translate('reviews') }}
                                                        </a>
                                                    </li>
                                                ...
                                                <div class="tab-content px-lg-3">
                                                    <div class="tab-pane fade text-justify" id="overview"
                                                        role="tabpanel">
        ...
        <div class="bottom-sticky bg-white d-sm-none">
            <div class="d-flex py-3 align-items-center justify-content-around">
                ...
                <div class="d-flex gap-3 justify-content-center">
                    @if (
                        ...
                        <button
                            class="btn btn--primary btn-sm  btn-gap-{{ Session::get('direction') === 'rtl' ? 'left' : 'right' }}"
                            type="button" disabled>
                            {{ translate('add_to_cart') }}
                        </button>
                    @else
                        ...
                        <button
                            class="btn btn--primary btn-sm  btn-gap-{{ Session::get('direction') === 'rtl' ? 'left' : 'right' }} action-add-to-cart-form"
                            type="button">
                            <span class="">{{ translate('add_to_cart') }}</span>
                        </button>
                    @endif
                ...
                <div class="card __card border-0">
                    <div class="card-body">
                        <div class="row flex-between">
                            <div class="ms-1">
                                <h4 class="text-capitalize font-bold fs-16">{{ translate('similar_productssss') }}</h4>
                            </div>
...
@push('script')
    ...
    {{-- <script>
        $(document).ready(function() {
            ...
            // Bind click event on add-to-cart button with class 'action-add-to-cart-form'
            $(document).on('click', '.action-add-to-cart-form', function(e) {
                e.preventDefault();
                addToCart('add-to-cart-form');
            });

            // Add to cart function: sends AJAX post with form data
            ...
            // You must have this validation function defined on your page
            // Example stub:
            function checkAddToCartValidity(form_id) {
                // Perform any validation necessary before adding to cart
                // Return true if valid, false otherwise
                return true;
            }

            // You must have this function to update cart navigation if used
