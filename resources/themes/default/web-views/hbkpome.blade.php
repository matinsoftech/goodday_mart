    ...
    <div class="__inline-61">
        ...
        <div class="featured_sec">
            <div class="wrap container">
                {{-- <h3 class="barlow-bold home-title mb-4">Featured Products</h3> --}}
                <div class="featured">
                    <div class="main">
                        <figure>
                            <img src="{{ asset('public/assets/front-end/img/Vegetable Banner.png') }}" alt="Banner 1">
                        </figure>
                    </div>
                    <div class="rect">
                        <figure>
                            <img src="{{ asset('public/assets/front-end/img/Fruit Banner.png') }}" alt="">
                        </figure>
                    </div>
                    <div class="rect">
                        <figure>
                            <img src="{{ asset('public/assets/front-end/img/Drink Banner.png	') }}" alt="">
                        </figure>
                    </div>
                </div>
            </div>
            ...
            <div class="container pt-5 pb-5 mb-2 mb-md-4 rtl __inline-35" dir="{{ Session::get('direction') }}">
                <div class="d-flex justify-content-between align-items-center mb-14px product-head-border">
                    <div class="text-center mb-2">
                        <span class="for-feature-title __text-22px font-bold text-center barlow-bold">
                            Shop by Categories
                        </span>
                    </div>
                    <div class="mr-1">
                        <a class="text-capitalize view-all-text web-text-primary d-flex algin-items-center gap-3"
                           href="{{route('products')}}">
                            {{ translate('view_all')}}
        ...
        <!-- Testimonial Start -->
        {{-- <div class="testimonial_sec mt-5">
            <div class="wrap container">
                <h2 class="text-center barlow-medium text-white text-uppercase mb-3">
                    What our client say
                </h2>
                <div class="owl-carousel owl-theme owl-testimonial">
                    <div class="item">
                        <figure class="mx-auto">
                            <img class="rounded-circle" src="https://randomuser.me/api/portraits/women/54.jpg" alt="White">
                        </figure>
                        <p class="testimonial text-center barlow-medium text-uppercase">Grocery exceeded my expectations!
                            Easy navigation, fast checkout, and my order arrived quickly and exactly as described. Excellent
                            customer service—highly recommend!</p>
                        <span class="client_name mt-3 d-block text-center barlow-medium text-uppercase">Ashim Rai</span>
                    ...
                    <div class="item">
                        <figure class="mx-auto">
                            <img class="rounded-circle" src="https://randomuser.me/api/portraits/men/64.jpg" alt="White">
                        </figure>
                        <p class="testimonial text-center barlow-medium text-uppercase">Grocery exceeded my expectations!
                            Easy navigation, fast checkout, and my order arrived quickly and exactly as described. Excellent
                            customer service—highly recommend!</p>
                        <span class="client_name mt-3 d-block text-center barlow-medium text-uppercase">Anupam Gupta</span>
                        <div class="client_rate">
                            <span></span>
                        </div>
                    </div>
                    ...
                    <div class="testimonial-slider col-lg-5 col-md-5 col-sm-12">
                        <div class="owl-carousel owl-theme owl-testimonial h-100" id="owl-testimonial">
                            <div class="testimonial-top">
                                <div class="d-flex gap-4 mb-4 align-items-center justify-content-start">
                                    <div>
                                        <img class="rounded-circle testimonial-client-img"
                                            src="https://randomuser.me/api/portraits/women/54.jpg" alt="">
                                    </div>
                                    <div class="clients-info">
                                        <h5 class="mb-1 __name">Chris Hoang</h5>
                                ...
                                <p class="mb-0 __content">“Conveniently synergize premium collaboration and idea-sharing
                                    with compelling "outside the box" thinking. Interactivel product distinctive paradigms
                            ...
                            <div class="testimonial-top">
                                <div class="d-flex gap-4 mb-4 align-items-center justify-content-start">
                                    ...
                                    <div class="clients-info">
                                        <h5 class="mb-1 __name">Chris Hoang Siama</h5>
                                        <ul class="d-flex align-items-center fs-xs text-warning"
                                            style="list-style: none;">
                                            <li><i class="fa fa-star"></i></li>
                                            <li><i class="fa fa-star"></i></li>
