...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:ital,wght@0,100..900;1,100..900&display=swap"
        rel="stylesheet">
    <link rel="stylesheet" media="screen" href="{{ theme_asset(path: 'public/assets/front-end/css/theme.css') }}?v={{ time() }}">
    ...
    <link rel="stylesheet" href="{{ theme_asset(path: 'public/assets/front-end/css/master.css') }}?v={{ time() }}" />
    ...
    <link rel="stylesheet" href="{{ theme_asset(path: 'public/assets/back-end/vendor/icon-set/style.css') }}?v={{ time() }}">
    <link rel="stylesheet" href="{{ theme_asset(path: 'public/assets/front-end/css/owl.carousel.min.css') }}">
    <link rel="stylesheet" href="{{ asset('public/assets/front-end/css/header.css') }}?v={{ time() }}">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link
    ...
    <link rel="stylesheet" href="{{ theme_asset(path: 'public/assets/front-end/css/style.css') }}?v={{ time() }}">
    <link rel="stylesheet" href="{{ theme_asset(path: 'public/assets/front-end/css/custom.css') }}?v={{ time() }}">
...
<body class="toolbar-enabled">
    ...
    <script src="{{ theme_asset(path: 'public/assets/front-end/js/custom.js') }}?v=<?php echo time(); ?>"></script>
    {!! Toastr::message() !!}
    <script>
    ...
    <script>
        ...
        $(".navbar_sm .navbar_toggler").on('click', function() {
            $(".navbar_sm .navbar_collapse").toggleClass("show");
        });
        "use strict";
    ...
    <script>
        $(window).on('load', function() {
            $(".loader-wrap").toggleClass("d-none");
        });
    </script>
</body>
</html>
