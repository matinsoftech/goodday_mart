...
<div class="navbar-tool dropdown {{ Session::get('direction') === 'rtl' ? 'mr-0 mr-md-3' : 'ml-0 ml-md-3' }}">
    @if ($web_config['guest_checkout_status'] || auth('customer')->check())
        <a class="ml-0 navbar-tool-icon-box bg-secondary dropdown-toggle d-flex align-items-center justify-content-center mr-0"
            ...
            <img src="{{ asset('public/assets/front-end/img/added/icons/cart-icon.png') }}" alt="wishlist"
                style="width: 25px;">
        </a>
    ...
    @else
        <a class="navbar-tool-icon-box bg-secondary dropdown-toggle d-flex align-items-center justify-content-center mr-0"
