                                ...
                                @foreach($categories as $category)
                                    <li class="__inline-17 dropdown-submenu position-relative">
                                        <div class="dropdown-item d-flex justify-content-between align-items-center p-0">
                                            <a class="dropdown-item w-100 d-flex justify-content-between align-items-center"
                                        ...
                                        @if($category->childes->count())
                                            <ul class="dropdown-menu sub-menu">
                                                @foreach($category->childes as $sub)
                                                    <li>
                                                        <a class="dropdown-item" href="{{ route('products', ['id' => $sub->id, 'data_from' => 'category', 'page' => 1]) }}">
                                                            {{ $sub->name }}
                                                        </a>
                                                    </li>
                                                @endforeach
